...
public class Game extends Canvas implements Runnable, KeyListener
{
	...
	public static void loadGameElements()
	{
		...
		Ghost.ghostArray[0] = new HostileGhost(0, Ghost.spawnBoxX, Ghost.spawnBoxY); 
		Ghost.ghostArray[1] = new HostileGhost(1, Ghost.spawnBoxX, Ghost.spawnBoxY);
		Ghost.ghostArray[2] = new HostileGhost(2, Ghost.spawnBoxX, Ghost.spawnBoxY);
		Ghost.ghostArray[3] = new HostileGhost(3, Ghost.spawnBoxX, Ghost.spawnBoxY);
