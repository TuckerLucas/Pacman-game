...
public class Game extends Canvas implements Runnable, KeyListener
{
	...
	public static void loadGameElements()
	{
		...
		Ghost.ghostArray[0] = new HostileGhost(Ghost.spawnBoxX, Ghost.spawnBoxY, 0);
		Ghost.ghostArray[1] = new HostileGhost(Ghost.spawnBoxX, Ghost.spawnBoxY, 1);
		Ghost.ghostArray[2] = new HostileGhost(Ghost.spawnBoxX, Ghost.spawnBoxY, 2);
		Ghost.ghostArray[3] = new HostileGhost(Ghost.spawnBoxX, Ghost.spawnBoxY, 3);
