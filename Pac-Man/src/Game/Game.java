...
public class Game extends Canvas implements Runnable, KeyListener
{
	...
	public static void loadGameElements()
	{
		...
		Ghost.ghostArray[0] = new HostileGhost(0, 320, 320, Character.right, Character.right, HostileGhost.movingRandomly); 
		Ghost.ghostArray[1] = new HostileGhost(1, 320, 320, Character.right, Character.right, HostileGhost.movingRandomly);
		Ghost.ghostArray[2] = new HostileGhost(2, 320, 320, Character.right, Character.right, HostileGhost.movingRandomly);
		Ghost.ghostArray[3] = new HostileGhost(3, 320, 320, Character.right, Character.right, HostileGhost.movingRandomly);
