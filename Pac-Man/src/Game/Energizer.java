...
public class Energizer extends Food
{
	...
	public static void turnGhostsVulnerable()
	{
		...
		{
			Ghost.ghostArray[i] = new VulnerableGhost(Ghost.ghostArray[i].x, Ghost.ghostArray[i].y, i, Ghost.ghostArray[i].movementType, Ghost.ghostArray[i].portalCrossingStatus);
		}
	...
	public static void turnGhostsHostile()
	{
		for(int i = 0; i < Ghost.ghostArray.length; i++)
		{
			Ghost.ghostArray[i] = new HostileGhost(Ghost.ghostArray[i].x, Ghost.ghostArray[i].y, i, Ghost.ghostArray[i].movementType, Ghost.ghostArray[i].portalCrossingStatus);
		}
	}
